...
```bash
gh api -X PUT repos/shrrth/multi-guest-live/branches/main/protection \
...
2. VPS 에서 이전 이미지로 되돌리기: `API_IMAGE=ghcr.io/shrrth/multi-guest-live/api:sha-xxxxxxx docker compose up -d`
